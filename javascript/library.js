...
// This function removes a book and prints the remaining books when the remove 
// book button is clicked
function removePrintBooks() {
    ...
    bookNameArray.forEach(bookName => {
        ...
        // the title of the book is written into the paragraph
        pTitle.appendChild(titleText);
        // the paragraph with the title of the book is added to the book info 
        // div
        childDiv1.appendChild(pTitle);
        ...
        // the author is written into the paragraph
        pAuthor.appendChild(authorText);
        // the paragraph with the author of the book is added to the book info 
        // div
        childDiv1.appendChild(pAuthor);
        ...
        const publisherText = document.createTextNode(
            `Publisher: ${nextBook.getPublisher()}`
        );
        // the publisher is written into the paragraph
        pPublisher.appendChild(publisherText);
        // the paragraph with the publisher of the book is added to the book 
        // info div
        childDiv1.appendChild(pPublisher);
        ...
        // the publication date of the book
        const pubDateText = document.createTextNode(
            `Publication date: ${nextBook.getPublicationDate()}`
        );
        // the publication date is written into the paragraph
        pPublicationDate.appendChild(pubDateText);
        // the paragraph with the publication date of the book is added to the 
        // book info div
        childDiv1.appendChild(pPublicationDate);
        ...
        // the page number of the book
        const pageNumberText = document.createTextNode(
            `Number of pages: ${nextBook.getNumOfPages()}`
        );
        // the page number is written into the paragraph
        pPageNumber.appendChild(pageNumberText);
        // the paragraph with the page number of the book is added to the book 
        // info div
        childDiv1.appendChild(pPageNumber);

        // add the book info div to the parent div
        parentDiv.appendChild(childDiv1);
        // add the parent div with the book info div and book button div to the 
        // list
        divBookList.appendChild(parentDiv);
